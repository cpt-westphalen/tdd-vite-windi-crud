	...
	return (
		...
		>
			<div className="flex justify-between items-center">
				<p className="font-bold">{product.producer || 'Produtor Fulano'}</p>
				<button className="text-xs m-0 p-0 w-8 text-center h-8 rounded-full">
					?
				</button>
			</div>
			...
			<div className="flex justify-between items-baseline pt-2 border-b border-solid border-b-zinc-700">
				...
				<p className="text-base text-zinc-300">{product.unit || '500 g'}</p>
			</div>
			<div className="my-2 flex justify-around items-center text-sm">
				<div className="bg-zinc-900 rounded-2xl px-2 py-1">vegan 🌱</div>
				<div className="bg-zinc-900 rounded-2xl px-2 py-1">agroforestry 🌳</div>
			</div>
